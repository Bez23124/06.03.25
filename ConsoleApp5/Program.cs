...
namespace ConsoleApp5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n 2-й способ: Массив объектов Point с инициализацией");
            ...
            Console.WriteLine("\n 3-й способ: Массив объектов Point, заполненный с клавиатуры");
            ...
            Console.WriteLine("\n 4-й способ: Динамический массив объектов Point, заполненный с клавиатуры");
            for (int i = 0; i < n; i++)
            {
